function [] = RENDER(BASE_01,BASE_02,elbow)
%% VERSION:
%   4
%   I N:
%       BASE_01 in frame {0} 
...
qs = I_KINEMATICS_getangles(BASE_02,elbow);
...
%% ********************  R E N D E R   G R I P P E R S  *******************
        % Gripper 02        
        G2_pos = get_GRIPPER(1,T_0_BASE02);
        
        % Gripper 01
        G1_pos = get_GRIPPER(-1,BASE_01);
...
%% **********************  D R A W    T H E    B O T  *********************
        ...
        %the robot
        plot3(x_pos,y_pos,z_pos, G2_pos(1,:),G2_pos(2,:),G2_pos(3,:), G1_pos(1,:),G1_pos(2,:),G1_pos(3,:),capture_x,capture_y,capture_z);
        hold on; 
